    ...
    <section id="work" className="section flex items-center justify-center">
      ...
      <div className="flex flex-col items-center justify-center w-full">
          <div className="text-center w-full max-w-[500px]">
            <h2 className="text-[3.6rem] mb-0 font-semibold text-left">Bask Health</h2>
            <p className="text-lg font-semibold text-[#7a7a7a] mb-2 text-left">Senior QA Engineer</p>
            <p className="text-base font-medium text-[#666564] mb-4 text-left">2025 - Present  // Remote </p>
            <p className="max-w-[500px] leading-relaxed mx-auto text-left">
              Working on building a comprehensive, scalable and modular automation framework using Playwright and Typescript. Authoring and maintaining clear actionable documentation. Establishing QA processes and best practices to streamline both the testing and development pipelines.
            </p>
          </div>
        ...
        <div className="flex flex-col items-center justify-center w-full">
          <div className="text-center w-full max-w-[500px]">
            ...
            <p className="text-lg font-semibold text-[#7a7a7a] mb-2 text-left">Automation Engineer</p>
          ...
          <div className="text-center w-full max-w-[500px]">
            ...
            <p className="text-lg font-semibold text-[#7a7a7a] mb-2 text-left">QA Engineer</p>
          ...
          <div className="text-center w-full max-w-[500px]">
            ...
            <p className="text-lg font-semibold text-[#7a7a7a] mb-2 text-left">QA Analyst</p>
